...
# License, v. 2.0. If a copy of the MPL was not included with this
# file, You can obtain one at http://mozilla.org/MPL/2.0/.

# NSIS branding defines for Kokoa Browser (twilight channel).
# Generated to override both surfer's branding output and Firefox official branding.
# BrandFullNameInternal is used for some registry and file system values
# instead of BrandFullName and typically should not be modified.
!define BrandFullNameInternal "Kokoa Browser Twilight"
!define BrandFullName         "Kokoa Browser Twilight"
...
!define URLManualDownload "https://github.com/tomjiu/kokoa-browser/releases"
...
!define PROFILE_CLEANUP_LABEL_LEFT "center"
